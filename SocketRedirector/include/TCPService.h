...
#ifndef INDIGO_TCP_SERVICE_H_
#define INDIGO_TCP_SERVICE_H_
...
namespace indigo {
	class TCPService : public ISocketService {
	...
	public:
		...
		virtual bool OnDataReceived(std::basic_string<uint8_t> &buffer) = 0;
	};
}

#endif // INDIGO_TCP_SERVICE_H_